...
@XmlSeeAlso({
    VehModifyRQ.VehModifyRQCore.class
})
public class VehicleModifyRQCoreType {
    ...
    protected RateRestriction rateRestriction;
     ...
     * @return
     *     possible object is
     *     {@link RateRestriction }
     *     
     */
    public RateRestriction getRateRestriction() {
     ...
     *     
     */
    public void setRateRestriction(RateRestriction value) {
