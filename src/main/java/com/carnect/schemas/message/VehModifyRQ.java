...
public class VehModifyRQ {
    ...
    protected List<VehModifyRQCore> vehModifyRQCore;
    @XmlElement(name = "VehModifyRQInfo")
    protected List<VehModifyRQInfo> vehModifyRQInfo;
     ...
     * {@link VehModifyRQCore }
     * 
     * 
     */
    public List<VehModifyRQCore> getVehModifyRQCore() {
        if (vehModifyRQCore == null) {
            vehModifyRQCore = new ArrayList<VehModifyRQCore>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VehModifyRQInfo }
     * 
     * 
     */
    public List<VehModifyRQInfo> getVehModifyRQInfo() {
        if (vehModifyRQInfo == null) {
            vehModifyRQInfo = new ArrayList<VehModifyRQInfo>();
        }
