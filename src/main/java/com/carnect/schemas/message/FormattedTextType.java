...
@XmlSeeAlso({
    ArrayOfVehicleLocationAdditionalDetailsTypeShuttleShuttleInfo.ShuttleInfo.class,
    ArrayOfVehicleLocationRequirementsTypeAgeAgeInfo.AgeInfo.class,
    ArrayOfVehicleLocationVehiclesTypeVehicleInfo.VehicleInfo.class,
    ArrayOfVehicleLocationRequirementsTypeAdditionalDriverAddlDriverInfo.AddlDriverInfo.class,
    ArrayOfVehicleLocationServicesOfferedTypeOffLocationService.OffLocationService.OffLocServiceDesc.class,
    VendorMessageType.class,
    ArrayOfVehicleLocationRequirementsTypeRequirementInfo.RequirementInfo.class,
    VehicleLocationInformationType.class,
    ArrayOfVehicleLocationServicesOfferedTypeOnLocationService.OnLocationService.OnLocServiceDesc.class
})
