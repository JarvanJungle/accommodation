...
public class ArrayOfVehicleLocationServicesOfferedTypeOnLocationServiceOnLocServiceCharge {
    ...
    protected List<OnLocServiceCharge> onLocServiceCharge;
     ...
     * {@link OnLocServiceCharge }
     * 
     * 
     */
    public List<OnLocServiceCharge> getOnLocServiceCharge() {
        if (onLocServiceCharge == null) {
            onLocServiceCharge = new ArrayList<OnLocServiceCharge>();
        }
