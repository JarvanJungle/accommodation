...
public class ArrayOfVehicleLocationServicesOfferedTypeOffLocationService {
    ...
    protected List<OffLocationService> offLocationService;
     ...
     * {@link OffLocationService }
     * 
     * 
     */
    public List<OffLocationService> getOffLocationService() {
        if (offLocationService == null) {
            offLocationService = new ArrayList<OffLocationService>();
        }
    ...
    public static class OffLocationService {
        ...
        protected OffLocServiceDesc offLocServiceDesc;
         ...
         * @return
         *     possible object is
         *     {@link OffLocServiceDesc }
         *     
         */
        public OffLocServiceDesc getOffLocServiceDesc() {
         ...
         *     
         */
        public void setOffLocServiceDesc(OffLocServiceDesc value) {
