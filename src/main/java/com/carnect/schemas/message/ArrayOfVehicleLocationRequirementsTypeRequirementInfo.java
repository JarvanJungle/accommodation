...
public class ArrayOfVehicleLocationRequirementsTypeRequirementInfo {
    ...
    protected List<RequirementInfo> requirementInfo;
     ...
     * {@link RequirementInfo }
     * 
     * 
     */
    public List<RequirementInfo> getRequirementInfo() {
        if (requirementInfo == null) {
            requirementInfo = new ArrayList<RequirementInfo>();
        }
