...
public class ArrayOfVehicleLocationServicesOfferedTypeOnLocationService {
    ...
    protected List<OnLocationService> onLocationService;
     ...
     * {@link OnLocationService }
     * 
     * 
     */
    public List<OnLocationService> getOnLocationService() {
        if (onLocationService == null) {
            onLocationService = new ArrayList<OnLocationService>();
        }
    ...
    public static class OnLocationService {
        ...
        protected OnLocServiceDesc onLocServiceDesc;
         ...
         * @return
         *     possible object is
         *     {@link OnLocServiceDesc }
         *     
         */
        public OnLocServiceDesc getOnLocServiceDesc() {
         ...
         *     
         */
        public void setOnLocServiceDesc(OnLocServiceDesc value) {
