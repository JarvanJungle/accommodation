...
public class ArrayOfVehicleLocationServicesOfferedTypeOffLocationServiceOffLocServiceCharge {
    ...
    protected List<OffLocServiceCharge> offLocServiceCharge;
     ...
     * {@link OffLocServiceCharge }
     * 
     * 
     */
    public List<OffLocServiceCharge> getOffLocServiceCharge() {
        if (offLocServiceCharge == null) {
            offLocServiceCharge = new ArrayList<OffLocServiceCharge>();
        }
