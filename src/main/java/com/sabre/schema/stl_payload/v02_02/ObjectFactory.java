 ...
 * generated in the com.sabre.services.stl_payload.v02_02 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApplicationResults_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "ApplicationResults");
    private final static QName _Results_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "Results");
    private final static QName _STLPayload_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "STL_Payload");
    private final static QName _STLRequestPayload_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "STL_Request_Payload");
    private final static QName _STLResponsePayload_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "STL_Response_Payload");
    private final static QName _STLNotifPayload_QNAME = new QName("http://services.sabre.com/STL_Payload/v02_02", "STL_Notif_Payload");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sabre.services.stl_payload.v02_02
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "ApplicationResults", substitutionHeadNamespace = "http://services.sabre.com/STL_Payload/v02_02", substitutionHeadName = "Results")
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "Results")
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "STL_Payload")
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "STL_Request_Payload", substitutionHeadNamespace = "http://services.sabre.com/STL_Payload/v02_02", substitutionHeadName = "STL_Payload")
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "STL_Response_Payload", substitutionHeadNamespace = "http://services.sabre.com/STL_Payload/v02_02", substitutionHeadName = "STL_Payload")
     ...
     */
    @XmlElementDecl(namespace = "http://services.sabre.com/STL_Payload/v02_02", name = "STL_Notif_Payload", substitutionHeadNamespace = "http://services.sabre.com/STL_Payload/v02_02", substitutionHeadName = "STL_Payload")
