 ...
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;attribute name="code" use="required" type="{http://services.sabre.com/sp/reservation/v2_4}CarrierCode" /&gt;
 *                 &lt;attribute name="level" use="required" type="{http://services.sabre.com/sp/reservation/v2_4}ValidatingCarrierPreferLevelType" /&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="code" type="{http://services.sabre.com/sp/reservation/v2_4}CarrierCode" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
