 ...
 *         &lt;element name="Vendor" type="{http://services.sabre.com/sp/reservation/v2_4}CompanyType" minOccurs="0"/&gt;
 *         &lt;element name="Service" type="{http://services.sabre.com/sp/reservation/v2_4}ServiceType" minOccurs="0"/&gt;
 *         &lt;element name="ServiceProvider" type="{http://services.sabre.com/sp/reservation/v2_4}ServiceProviderType" minOccurs="0"/&gt;
 *         &lt;element name="StartDetails" type="{http://services.sabre.com/sp/reservation/v2_4}LocationDetailsType" minOccurs="0"/&gt;
 *         &lt;element name="StopDetails" type="{http://services.sabre.com/sp/reservation/v2_4}LocationDetailsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="EndDetails" type="{http://services.sabre.com/sp/reservation/v2_4}LocationDetailsType" minOccurs="0"/&gt;
 *         &lt;element name="ExternalReservation" type="{http://services.sabre.com/sp/reservation/v2_4}ExternalReservationType" minOccurs="0"/&gt;
 *         &lt;element name="Restrictions" type="{http://services.sabre.com/sp/reservation/v2_4}RestrictionsType" minOccurs="0"/&gt;
 *         &lt;element name="POS" type="{http://services.sabre.com/sp/reservation/v2_4}POSType"/&gt;
 *         &lt;element name="AgentLoyalty" type="{http://services.sabre.com/sp/reservation/v2_4}LoyaltyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Passenger" type="{http://services.sabre.com/sp/reservation/v2_4}PassengerType" maxOccurs="99" minOccurs="0"/&gt;
 *         &lt;element name="RateQualifier" type="{http://services.sabre.com/sp/reservation/v2_4}RateQualifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
