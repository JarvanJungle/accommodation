 ...
 *         &lt;element name="TierLabels" type="{http://services.sabre.com/hotel/content/v4_0_0}TierLabels" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="HotelCode" use="required" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to20" /&gt;
 *       &lt;attribute name="CodeContext" use="required" type="{http://services.sabre.com/hotel/content/v4_0_0}CodeContextType" /&gt;
 *       &lt;attribute name="HotelName" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to500" /&gt;
 *       &lt;attribute name="ChainCode" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to20" /&gt;
 *       &lt;attribute name="ChainName" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to500" /&gt;
 *       &lt;attribute name="BrandCode" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to50" /&gt;
 *       &lt;attribute name="BrandName" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to500" /&gt;
 *       &lt;attribute name="Status" type="{http://services.sabre.com/hotel/content/v4_0_0}PropertyStatusType" /&gt;
 *       &lt;attribute name="SabreRating" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength0to10" /&gt;
 *       &lt;attribute name="SabreHotelCode" type="{http://services.sabre.com/hotel/content/v4_0_0}StringLength1to20" /&gt;
...
@XmlType(namespace="content", name = "HotelInfo", propOrder = {
    "tierLabels"
})
