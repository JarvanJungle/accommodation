 ...
 *                 &lt;attribute name="CodeContext" type="{http://services.sabre.com/hotel/details/v3_0_0}CodeContextType" default="SABRE" /&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
...
@XmlType(namespace = "details", name = "HotelRefs", propOrder = {
    "hotelRef"
})
public class HotelRefs {

    @XmlElement(name = "HotelRef", required = true)
    protected HotelRefs.HotelRef hotelRef;
     ...
     *
     */
    public HotelRefs.HotelRef getHotelRef() {
        return hotelRef;
    }
     ...
     *
     */
    public void setHotelRef(HotelRefs.HotelRef value) {
        this.hotelRef = value;
    }
