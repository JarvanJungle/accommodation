...
@ToString
@Data
public class TransportCancelRQ extends AbstractRQ implements Serializable
{
	/**
	 * 
	 */
	...
	private Set<TransportCancelRQ.RequestItem> items = new HashSet<TransportCancelRQ.RequestItem>();
