...
@ToString
@Data
public class RetrieveTransferRQ extends AbstractRQ implements Serializable
{
	private static final long serialVersionUID = 1L;

	@ApiModelProperty(notes = "The source channel of this item, from the Room=>Source field in search results", example = "JAYRIDE", required = true)
