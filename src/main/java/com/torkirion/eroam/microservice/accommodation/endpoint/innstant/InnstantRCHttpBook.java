...
@Slf4j
public class InnstantRCHttpBook extends HttpService
{
	private InnstantRCAPIProperties innstantRCAPIProperties;

	public InnstantRCHttpBook(InnstantRCAPIProperties innstantRCAPIProperties)
	{
	...
	{
		return innstantRCAPIProperties.innstantRCBook;
	}
}
