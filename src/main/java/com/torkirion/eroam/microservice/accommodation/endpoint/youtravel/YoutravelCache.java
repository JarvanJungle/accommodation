...
public class YoutravelCache
{
	...
	public YoutravelCache(YoutravelStaticRepo youtravelStaticRepo)
	{
		this.youtravelStaticRepo = youtravelStaticRepo;
	}
	...
	public Optional<String> getChainDescription(String chainCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("CategoriesRS", chainCode);
		if (l != null && l.size() > 0)
		{
	...
	public Optional<String> getCategoryDescription(String categoryCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("CategoriesRS", categoryCode);
		if (l != null && l.size() > 0)
		{
	...
	public Optional<String> getBoard(String boardCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("BoardsRS", boardCode);
		if (l != null && l.size() > 0)
		{
			String type = l.get(0).getCgroup();
			if (type != null)
	...
	public Optional<String> getPromotion(String promotionCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("PromotionsRS", promotionCode);
		if (l != null && l.size() > 0)
		{
			String type = l.get(0).getCgroup();
			if (type != null)
	...
	public Optional<String> getIssueDescription(String issueType, String issueCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("IssuesRS", code);
		if (l != null && l.size() > 0)
		{
	...
	public Optional<String> getImageDescription(String imageCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("ImageTypesRS", imageCode);
		if (l != null && l.size() > 0)
		{
			String val = l.get(0).getDescription();
			if (val != null)
	...
	public Optional<String> getFacilityDescription(String facilityCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("FacilitiesRS", facilityCode);
		if (l != null && l.size() > 0)
		{
			String val = l.get(0).getDescription();
			if (val != null)
	...
	public Optional<String> getSegmentDescription(String segmentCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("SegmentsRS", segmentCode);
		if (l != null && l.size() > 0)
		{
			String val = l.get(0).getDescription();
			if (val != null)
	...
	public Optional<String> getTerminalDescription(String terminalCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("TerminalsRS", terminalCode);
		if (l != null && l.size() > 0)
		{
			String val = l.get(0).getDescription();
			if (val != null)
	...
	public Set<RateComment> getRateComments(String rateCommentCode)
	{
		...
		List<YoutravelStaticData> l = youtravelStaticRepo.findByStaticTypeAndCode("BoardsRS", rateCommentCode);
		if (l != null && l.size() > 0)
		{
			Set<RateComment> rcSet = new HashSet<>();
			for (YoutravelStaticData sd : l)
			{
