...
public interface IMSTransportationBasicRepo extends JpaRepository<TransportationBasic, Long>
{
	public List<TransportationBasic> findAllBySearchIataFromAndSearchIataTo(String searchIataTo, String searchIataFrom);
	public List<TransportationBasic> findAllByFlight(String flight);
}