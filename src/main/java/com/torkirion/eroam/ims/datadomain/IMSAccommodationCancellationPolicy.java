...
@Entity
@Table(name = "imsaccommodationcnxpolicy", indexes = {
			@Index(name = "imsaccommodationcnxpolicy_hotelid", columnList="hotelId", unique = false) 
			})
@Data
public class IMSAccommodationCancellationPolicy
{
